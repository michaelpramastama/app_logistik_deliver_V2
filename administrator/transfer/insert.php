...
if(move_uploaded_file($tmp, $path)){ // Cek apakah gambar berhasil diupload atau tidak
  // Proses simpan ke Database
	$query = "INSERT INTO uang_masuk(`id`, `agent`, `date`, `time`, `nominal`, `keterangan`, `bukti`) VALUES (NULL,'$agent','$date','$time','$nominal','$keterangan','$fotobaru')";
    ...
    if($sql){ // Cek jika proses simpan ke database sukses atau tidak
		...
		$update1 = "UPDATE agent SET pendapatan = pendapatan - '$nominal' where id = '$agent'";
